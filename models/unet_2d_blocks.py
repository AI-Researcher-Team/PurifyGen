...
from model.p4dn.transformer_2d import Transformer2DModel
...
def get_down_block(
    ...
    elif down_block_type == "ModifiedCrossAttnDownBlock2D":
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for ModifiedCrossAttnDownBlock2D")
        return ModifiedCrossAttnDownBlock2D(
            num_layers=num_layers,
